...
export class HomePageComponent implements OnInit {
  ...
  Faqs = [
    ...
    },
    {
      ...
      text: 'HONSHU is the utility token of the Honshūverse that will be used for the launch of Gen 2. You can get it by holding your Honshū NFTs in your wallet.',
      id: 4
    },
    {
